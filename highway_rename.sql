...
salary_contractor bigint, starting_schedule date, ending_schedule date, labour_age int, acccident_involved_girl varchar(30),
 acccident_involved_boy varchar(30),fatal_accidents int, nonfatal_accidents int, total_accidents int,died_person_name varchar(30),year_of_construction varchar(30),landmark varchar(30));
...
SELECT id FROM highway where states ='uttarpradesh';
SELECT number FROM highway where length_of_nh =577;
SELECT country FROM highway where vehicle ='car';
SELECT total FROM highway where district ='Udupi';
SELECT investing_amount FROM highway where investing_amount =220000;
SELECT id FROM highway where office_name ='Shree';
SELECT labour_age FROM highway where contractor_name ='Vinesh';
SELECT no_days FROM highway where fatal_accidents =12;
SELECT ending_schedule FROM highway where nonfatal_accidents =16;
SELECT quantity FROM highway where labours ='Ganesh';

SELECT * FROM highway WHERE states = 'uttarpradesh' AND  id = 1;
SELECT * FROM highway WHERE length_of_nh = 577 AND  id = 5;
SELECT * FROM highway WHERE country = 'australia' AND  office_name = 'Shree';
SELECT * FROM highway WHERE salary_contractor = 20000 AND  contractor_name = 'Vinesh';
SELECT * FROM highway WHERE quantity = 3 AND  nonfatal_accidents = 16;

SELECT * FROM highway WHERE states = 'uttarpradesh' AND  id = 1;
SELECT * FROM highway WHERE length_of_nh = 577 AND  id = 5;
SELECT * FROM highway WHERE country = 'India' AND  office_name = 'shree';
SELECT * FROM highway WHERE salary_contractor = 9990000 AND  contractor_name = 'Vinesh';
SELECT * FROM highway WHERE quantity = 3 AND  nonfatal_accidents = 16;

SELECT * FROM highway;

UPDATE highway SET states = 'Karnataka'; 
UPDATE highway SET country = 'India'; 
UPDATE highway SET quantity = 3; 
UPDATE highway SET office_name = 'office_name'; 
UPDATE highway SET vehicle = 'car'; 
UPDATE highway SET district = 'Udupi'; 
UPDATE highway SET contractor_name = 'xyz'; 
UPDATE highway SET Language = 'Kannada'; 
UPDATE highway SET nonfatal_accidents = 8; 
UPDATE highway SET total_accidents = 20; 
